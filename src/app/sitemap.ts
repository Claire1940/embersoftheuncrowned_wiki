...
const BASE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://embersoftheuncrowned.wiki'

// 内容类型优先级配置（与 navigation.ts 的 NAVIGATION_CONFIG 分类一一对应）
...
// 内容更新频率配置（与 navigation.ts 的 NAVIGATION_CONFIG 分类一一对应）
