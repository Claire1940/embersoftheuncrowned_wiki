...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://embersoftheuncrowned.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Embers of the Uncrowned Wiki'
