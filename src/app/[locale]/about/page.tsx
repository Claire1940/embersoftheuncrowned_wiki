...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://embersoftheuncrowned.wiki'
  const path = '/about'

  return {
    title: 'About Embers of the Uncrowned Wiki - Your Ultimate Steam Game Resource',
    description: 'Learn about Embers of the Uncrowned Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Embers of the Uncrowned Steam game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: 'Embers of the Uncrowned Wiki',
      title: 'About Embers of the Uncrowned Wiki',
      description: 'Learn about our mission to provide the best Embers of the Uncrowned game resources and guides.',
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: 'Embers of the Uncrowned Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About Embers of the Uncrowned Wiki',
      description: 'Learn about our mission to provide the best Embers of the Uncrowned game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About Embers of the Uncrowned Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Embers of the Uncrowned
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Embers of the Uncrowned Wiki</h2>
            <p>
              Embers of the Uncrowned Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Steam game "Embers of the Uncrowned". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Embers of the Uncrowned Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Embers of the Uncrowned players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Embers of the Uncrowned Wiki as the <strong>go-to destination</strong> for every Embers of the Uncrowned player seeking
              to improve their gameplay. We want to be the resource that players trust and rely on, whether they need
              crafting guides, want to explore new biomes, or are looking for advanced combat tactics.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Comprehensive crafting recipes and gear upgrade guides to help you forge powerful equipment.
                Master the art of crafting and enhancement!
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                ...
                Explore every corner of the dark fantasy world safely.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Step-by-step guides to unlock every achievement in the game.
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Essential combat tips, build strategies, and exploration guides.
                Learn how to thrive in the dark fantasy world.
              </p>
            </div>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Embers of the Uncrowned Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Embers of the Uncrowned Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Embers of the Uncrowned as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Embers of the Uncrowned mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Embers of the Uncrowned Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developer of Embers of the Uncrowned (NEXON) or any official entities.
            </p>
            <p>
            ...
            <p>
              Embers of the Uncrowned Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@embersoftheuncrowned.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@embersoftheuncrowned.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@embersoftheuncrowned.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@embersoftheuncrowned.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@embersoftheuncrowned.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@embersoftheuncrowned.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@embersoftheuncrowned.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@embersoftheuncrowned.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Embers of the Uncrowned news.
