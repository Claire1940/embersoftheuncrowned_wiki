...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Embers of the Uncrowned Wiki',
    description: 'Copyright and intellectual property information for Embers of the Uncrowned Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Embers of the Uncrowned Wiki',
      description: 'Copyright and intellectual property information for Embers of the Uncrowned Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Embers of the Uncrowned Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Embers of the Uncrowned Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Embers of the Uncrowned Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>NEXON</strong> - Creators of the Embers of the Uncrowned game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Embers of the Uncrowned</strong> - Trademark of the game developers</li>
              <li><strong>Embers of the Uncrowned Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Embers of the Uncrowned Wiki.
            </p>
            ...
            <p>
              ...
              Embers of the Uncrowned Wiki<br />
              Email: <a href="mailto:dmca@embersoftheuncrowned.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@embersoftheuncrowned.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Embers of the Uncrowned Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Embers of the Uncrowned Wiki (embersoftheuncrowned.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@embersoftheuncrowned.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@embersoftheuncrowned.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@embersoftheuncrowned.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@embersoftheuncrowned.wiki</a>
            </p>
            <p>
