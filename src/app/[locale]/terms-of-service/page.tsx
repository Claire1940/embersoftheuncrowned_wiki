...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Embers of the Uncrowned Wiki",
    description: "Read the Terms of Service for Embers of the Uncrowned Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Embers of the Uncrowned Wiki",
      description: "Terms and conditions for using Embers of the Uncrowned Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Embers of the Uncrowned Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Embers of the Uncrowned Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Embers of the Uncrowned Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Embers of the Uncrowned Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Steam game "Embers of the Uncrowned". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> Embers of the Uncrowned Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (Steam) or the official developer of Embers of the Uncrowned (NEXON). We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Embers of the Uncrowned Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (Steam) and/or the developer of Embers of the Uncrowned (NEXON). We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, EMBERS OF THE UNCROWNED WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Embers of the Uncrowned Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@embersoftheuncrowned.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@embersoftheuncrowned.wiki</a>
            </p>
            <p>
